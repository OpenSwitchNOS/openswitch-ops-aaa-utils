...
global global_tacacs_auth , global_tacacs_timeout, global_tacacs_passkey
...
def modify_common_auth_access_file(server_list):
    ...
    '''
    global global_tacacs_passkey, global_tacacs_timeout, global_tacacs_passkey
