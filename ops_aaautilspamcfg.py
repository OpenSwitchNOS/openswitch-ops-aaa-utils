...
def modify_common_auth_session_file(fallback_value, radius_value, radius_xap_value):
    '''
    ...
    if radius_xap_value == RADIUS_CHAP:
        #for auth use chap enabled library
...
def update_access_files():
    ...
    modify_common_auth_session_file(fallback_value, radius_value, radius_auth_value)
