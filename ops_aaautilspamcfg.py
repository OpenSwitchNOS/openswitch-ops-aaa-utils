...
def add_default_row():
    ...
    setattr(local_row, AAA_SERVER_GROUP_IS_STATIC, OPS_TRUE)
    ...
    setattr(tacacs_row, AAA_SERVER_GROUP_IS_STATIC, OPS_TRUE)
    ...
    setattr(radius_row, AAA_SERVER_GROUP_IS_STATIC, OPS_TRUE)
