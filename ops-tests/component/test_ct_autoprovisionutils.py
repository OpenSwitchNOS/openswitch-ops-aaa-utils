...
[type=oobmhost name="Host 1" image="openswitch/lighttpd-ubuntu"] h1
...
def executeautoprovision(sw1, h1):
    ...
    print("### Passed:Executing downloaded autoprovision script ###\n")
    ...
    print("### Passed: Verify autoprovision status updated in DB ###\n")
    ...
    print("### Passed:Executing autoprovision script again,"
