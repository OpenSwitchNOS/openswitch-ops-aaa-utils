...
configure terminal
tacacs-server key tac_test
tacacs-server host 2001:DB8:3333:4::5
tacacs-server host 2001:DB8:1:4::5 key tac_test auth-type chap
aaa group server tacacs+ sg1
(config-sg) server 2001:DB8:3333:4::5
exit
aaa group server tacacs+ sg2
(config-sg) server 2001:DB8:1:4::5
exit
aaa authentication login default group sg1
```
