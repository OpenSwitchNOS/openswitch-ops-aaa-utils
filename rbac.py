...
#    ......
#    result = check_user_permission("user", rbac.DB_WRITE_ALL_TABLES)
#    if result == True:
#        /* User has write access to the DB */
#        /* Display the writeable configuration data */
#        ...
#    ......
#
...
#     ......
#     if rbac.DB_WRITE_ALL_TABLES in permissions_list:
#        /* User has write access to the DB */
#        /* Display the writeable configuration data */
#       ...
#    ......
#    if rbac.MGMT_WRITE_USER_ACCOUNT_INFO in permissions_list:
#       /* User has write access user accounts */
#       /* Display the user's account creation screen */
#      ...
#
# =============================================
import subprocess
