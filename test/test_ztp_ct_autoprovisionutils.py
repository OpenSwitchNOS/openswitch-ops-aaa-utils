...
class Test_autoprovisionfeature:
    ...
    def test_setupHttpServer(self):
        if self.test.setupHttpServer():
            print 'Passed setupHttpServer'

    def test_setupAutoprovisionScript(self):
        if self.test.setupAutoprovisionScript():
            print 'Passed setupAutoprovisionScript'
