...
10. Check configuration and verified the CHAP authentication method was removed.
...
*Objective:* Verify if the CHAP file is located in the appropiate location.
*Requirements:*
* Physical or Virtual Switch
...
*Description:*
Validate if the CHAP file is located in the appropiate location.

* Steps:

1. Verify if the file pam_radius_chap_auth.so is located in the appropiate location. (/lib/security)

*Test result criteria*
* Test pass criteria
1. The file pam_radius_chap_auth.so is located in the appropiate location. (/lib/security)

* Test fail criteria
1. The file pam_radius_chap_auth.so is not located in the appropiate location. (/lib/security).
