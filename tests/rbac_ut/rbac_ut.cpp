...
TEST_F(rbac_ut,rbac_get_user_role_multiple_users)
{
    ...
    tf += rbac_test_rbac_get_user_role(USER_GENERIC, RBAC_ROLE_NONE,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_BOGUS, "",
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_BLANK, "",
                         true,  true);
    tf += rbac_test_rbac_get_user_role(USER_NULL, "",
                         false, false);
    tf += rbac_test_rbac_get_user_role(USER_BOTH, RBAC_ROLE_ADMIN,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_NETOP_SHORT, "",
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_NETOP_LONG, "",
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_ADMIN_SHORT, "",
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_ADMIN_LONG, "",
                         true, true);
