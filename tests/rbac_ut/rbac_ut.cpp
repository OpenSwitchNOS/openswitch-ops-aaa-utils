 ...
 */
const char *ROLE_ROOT = "root";
const char *ROLE_ADMIN = "ops_admin";
const char *ROLE_NETOP = "ops_netop";
const char *ROLE_NONE = "none";
const char *ROLE_EMPTY = "";
...
/*
 * RBAC currently supports three permissions, listed below.
 */
const char *READ_SWITCH_CONFIG = "READ_SWITCH_CONFIG";
const char *WRITE_SWITCH_CONFIG = "WRITE_SWITCH_CONFIG";
const char *SYS_MGMT = "SYS_MGMT";
...
TEST_F(rbac_ut,rbac_get_user_role_multiple_users)
{
    ...
    tf += rbac_test_rbac_get_user_role(USER_ROOT, ROLE_ROOT,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_ADMIN_BI, ROLE_ADMIN,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_NETOP_BI, ROLE_NETOP,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_ADMIN, ROLE_ADMIN,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_NETOP, ROLE_NETOP,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_GENERIC, ROLE_NONE,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_BOGUS, ROLE_EMPTY,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_BLANK, ROLE_EMPTY,
                         true,  true);
    tf += rbac_test_rbac_get_user_role(USER_NULL, ROLE_EMPTY,
                         false, false);
    tf += rbac_test_rbac_get_user_role(USER_BOTH, ROLE_ADMIN,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_NETOP_SHORT, ROLE_EMPTY,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_NETOP_LONG, ROLE_EMPTY,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_ADMIN_SHORT, ROLE_EMPTY,
                         true, true);
    tf += rbac_test_rbac_get_user_role(USER_ADMIN_LONG, ROLE_EMPTY,
                         true, true);
...
TEST_F(rbac_ut,rbac_check_user_permission_user_root)
{
    ...
    tf += rbac_test_rbac_check_user_permission(USER_ROOT,
                         RBAC_SYS_MGMT, true);
    tf += rbac_test_rbac_check_user_permission(USER_ROOT,
                         READ_SWITCH_CONFIG, true);
    tf += rbac_test_rbac_check_user_permission(USER_ROOT,
                         WRITE_SWITCH_CONFIG, true);
    tf += rbac_test_rbac_check_user_permission(USER_ROOT,
                         SYS_MGMT, true);
    tf += rbac_test_rbac_check_user_permission(USER_ROOT,
                         "", false);
...
TEST_F(rbac_ut,rbac_check_user_permission_builtin_admin)
{
    ...
    tf += rbac_test_rbac_check_user_permission(USER_ADMIN_BI,
                         RBAC_SYS_MGMT, true);
    tf += rbac_test_rbac_check_user_permission(USER_ADMIN_BI,
                         READ_SWITCH_CONFIG, false);
    tf += rbac_test_rbac_check_user_permission(USER_ADMIN_BI,
                         WRITE_SWITCH_CONFIG, false);
    tf += rbac_test_rbac_check_user_permission(USER_ADMIN_BI,
                         SYS_MGMT, true);
    tf += rbac_test_rbac_check_user_permission(USER_ADMIN_BI,
                         "", false);
...
TEST_F(rbac_ut,rbac_get_user_permissions_user_root)
{
    ...
    tf += rbac_test_rbac_get_user_permissions(USER_ROOT,
                         READ_SWITCH_CONFIG, true, true);
    tf += rbac_test_rbac_get_user_permissions(USER_ROOT,
                         WRITE_SWITCH_CONFIG, true, true);
    tf += rbac_test_rbac_get_user_permissions(USER_ROOT, SYS_MGMT,
                         true, true);
...
TEST_F(rbac_ut,rbac_get_user_permissions_user_builtin_admin)
{
    ...
    tf += rbac_test_rbac_get_user_permissions(USER_ADMIN_BI,
                             READ_SWITCH_CONFIG, true, false);
    tf += rbac_test_rbac_get_user_permissions(USER_ADMIN_BI,
                             WRITE_SWITCH_CONFIG, true, false);
    tf += rbac_test_rbac_get_user_permissions(USER_ADMIN_BI,
                             SYS_MGMT, true, true);
...
TEST_F(rbac_ut,rbac_get_user_permissions_user_ops_admin)
{
    ...
    tf += rbac_test_rbac_get_user_permissions(USER_ADMIN,
                             WRITE_SWITCH_CONFIG, true, false);
    tf += rbac_test_rbac_get_user_permissions(USER_ADMIN, SYS_MGMT,
                             true, true);
...
TEST_F(rbac_ut,rbac_get_user_permissions_user_ops_netop)
{
    ...
    tf += rbac_test_rbac_get_user_permissions(USER_NETOP,
                             WRITE_SWITCH_CONFIG, true, true);
    tf += rbac_test_rbac_get_user_permissions(USER_NETOP, SYS_MGMT,
                             true, false);
...
TEST_F(rbac_ut,rbac_get_user_permissions_user_null)
{
    ...
    tf += rbac_test_rbac_get_user_permissions(USER_NULL,
                             READ_SWITCH_CONFIG, false, false);
    tf += rbac_test_rbac_get_user_permissions(USER_NULL,
                             WRITE_SWITCH_CONFIG, false, false);
    tf += rbac_test_rbac_get_user_permissions(USER_NULL,
                             SYS_MGMT, false, false);
